...
| `stil.einsatzleiste` | [`src/index.css:4514`](src/index.css#L4514) | Die angeheftete Leiste so flach wie möglich |
...
| `stil.hover` | [`src/index.css:4258`](src/index.css#L4258) | Hover nur mit echtem Zeiger - sonst klebt der Zustand |
...
| `stil.telefon` | [`src/index.css:4586`](src/index.css#L4586) | Anpassungen unter 760 px, inklusive Tabellenumbruch |
| `stil.tokens` | [`src/index.css:6`](src/index.css#L6) | Farben, Radien und Schatten der gesamten Oberfläche |
| `stil.touch` | [`src/index.css:4717`](src/index.css#L4717) | Mindestgroesse der Tippziele auf Touch-Geraeten |
...
| `ui.zugfuehrerseite` | [`src/pages/ZugfuehrerSeite.tsx:23`](src/pages/ZugfuehrerSeite.tsx#L23) | Startbildschirm des Zugführers: schlanker als das Gesamtlagebild |
