...
| `stil.einsatzleiste` | [`src/index.css:4169`](src/index.css#L4169) | Die angeheftete Leiste so flach wie möglich |
...
| `stil.hover` | [`src/index.css:3913`](src/index.css#L3913) | Hover nur mit echtem Zeiger - sonst klebt der Zustand |
...
| `stil.telefon` | [`src/index.css:4239`](src/index.css#L4239) | Anpassungen unter 760 px, inklusive Tabellenumbruch |
| `stil.tokens` | [`src/index.css:6`](src/index.css#L6) | Farben, Radien und Schatten der gesamten Oberfläche |
| `stil.touch` | [`src/index.css:4370`](src/index.css#L4370) | Mindestgroesse der Tippziele auf Touch-Geraeten |
...
| `ui.gesamtlagebild` | [`src/pages/GesamtlagebildSeite.tsx:22`](src/pages/GesamtlagebildSeite.tsx#L22) | Regie-Startbildschirm: eine Ansicht statt verstreuter Panels |
...
| `ui.regiebereichsseite` | [`src/components/RegieBereichsseite.tsx:13`](src/components/RegieBereichsseite.tsx#L13) | Regie-Bereiche als eigene Seite - dasselbe Muster wie ui.bereichsseite |
