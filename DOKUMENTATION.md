...
| `stil.einsatzleiste` | [`src/index.css:4264`](src/index.css#L4264) | Die angeheftete Leiste so flach wie möglich |
...
| `stil.hover` | [`src/index.css:4008`](src/index.css#L4008) | Hover nur mit echtem Zeiger - sonst klebt der Zustand |
...
| `stil.telefon` | [`src/index.css:4334`](src/index.css#L4334) | Anpassungen unter 760 px, inklusive Tabellenumbruch |
| `stil.tokens` | [`src/index.css:6`](src/index.css#L6) | Farben, Radien und Schatten der gesamten Oberfläche |
| `stil.touch` | [`src/index.css:4465`](src/index.css#L4465) | Mindestgroesse der Tippziele auf Touch-Geraeten |
