...
| `stil.einsatzleiste` | [`src/index.css:4239`](src/index.css#L4239) | Die angeheftete Leiste so flach wie möglich |
...
| `stil.hover` | [`src/index.css:3983`](src/index.css#L3983) | Hover nur mit echtem Zeiger - sonst klebt der Zustand |
...
| `stil.telefon` | [`src/index.css:4309`](src/index.css#L4309) | Anpassungen unter 760 px, inklusive Tabellenumbruch |
| `stil.tokens` | [`src/index.css:6`](src/index.css#L6) | Farben, Radien und Schatten der gesamten Oberfläche |
| `stil.touch` | [`src/index.css:4440`](src/index.css#L4440) | Mindestgroesse der Tippziele auf Touch-Geraeten |
...
| `ui.gesamtlagebild` | [`src/pages/GesamtlagebildSeite.tsx:19`](src/pages/GesamtlagebildSeite.tsx#L19) | Regie-Startbildschirm: eine Ansicht statt verstreuter Panels |
