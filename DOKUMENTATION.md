...
| `stil.einsatzleiste` | [`src/index.css:4628`](src/index.css#L4628) | Die angeheftete Leiste so flach wie möglich |
...
| `stil.hover` | [`src/index.css:4372`](src/index.css#L4372) | Hover nur mit echtem Zeiger - sonst klebt der Zustand |
...
| `stil.telefon` | [`src/index.css:4700`](src/index.css#L4700) | Anpassungen unter 760 px, inklusive Tabellenumbruch |
| `stil.tokens` | [`src/index.css:6`](src/index.css#L6) | Farben, Radien und Schatten der gesamten Oberfläche |
| `stil.touch` | [`src/index.css:4831`](src/index.css#L4831) | Mindestgroesse der Tippziele auf Touch-Geraeten |
...
| `ui.baufeld` | [`src/components/Baufeld.tsx:44`](src/components/Baufeld.tsx#L44) | Der Zugführer platziert echte Zelt- und Flächengrößen im Baufeld |
| `ui.baufeld.befehl` | [`src/components/Baufeld.tsx:69`](src/components/Baufeld.tsx#L69) | Auftragstaktik statt Direktbau, wenn ein Gruppenführer mitspielt |
...
| `ui.zugfuehrerseite` | [`src/pages/ZugfuehrerSeite.tsx:25`](src/pages/ZugfuehrerSeite.tsx#L25) | Startbildschirm des Zugführers: schlanker als das Gesamtlagebild |
