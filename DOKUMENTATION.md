...
_230 Anker, erzeugt von `npm run anker` – nicht von Hand ändern._
...
| `stil.einsatzleiste` | [`src/index.css:4472`](src/index.css#L4472) | Die angeheftete Leiste so flach wie möglich |
...
| `stil.hover` | [`src/index.css:4216`](src/index.css#L4216) | Hover nur mit echtem Zeiger - sonst klebt der Zustand |
...
| `stil.telefon` | [`src/index.css:4544`](src/index.css#L4544) | Anpassungen unter 760 px, inklusive Tabellenumbruch |
| `stil.tokens` | [`src/index.css:6`](src/index.css#L6) | Farben, Radien und Schatten der gesamten Oberfläche |
| `stil.touch` | [`src/index.css:4675`](src/index.css#L4675) | Mindestgroesse der Tippziele auf Touch-Geraeten |
...
| `ui.lagekarte` | [`src/components/Lagekarte.tsx:97`](src/components/Lagekarte.tsx#L97) | Echte, maßstabsgetreue Lagekarte statt Kartenansicht/Baufeld |
