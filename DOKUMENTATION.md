...
| `stil.einsatzleiste` | [`src/index.css:4578`](src/index.css#L4578) | Die angeheftete Leiste so flach wie möglich |
...
| `stil.hover` | [`src/index.css:4322`](src/index.css#L4322) | Hover nur mit echtem Zeiger - sonst klebt der Zustand |
...
| `stil.telefon` | [`src/index.css:4650`](src/index.css#L4650) | Anpassungen unter 760 px, inklusive Tabellenumbruch |
| `stil.tokens` | [`src/index.css:6`](src/index.css#L6) | Farben, Radien und Schatten der gesamten Oberfläche |
| `stil.touch` | [`src/index.css:4781`](src/index.css#L4781) | Mindestgroesse der Tippziele auf Touch-Geraeten |
...
| `ui.einsatzseite` | [`src/pages/EinsatzSeite.tsx:23`](src/pages/EinsatzSeite.tsx#L23) | Gesamtlagebild (Regie), Zugführer-Übersicht, Abschnittsliste oder Patientenseite |
