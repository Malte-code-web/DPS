...
| `stil.einsatzleiste` | [`src/index.css:4242`](src/index.css#L4242) | Die angeheftete Leiste so flach wie möglich |
...
| `stil.hover` | [`src/index.css:3986`](src/index.css#L3986) | Hover nur mit echtem Zeiger - sonst klebt der Zustand |
...
| `stil.telefon` | [`src/index.css:4312`](src/index.css#L4312) | Anpassungen unter 760 px, inklusive Tabellenumbruch |
| `stil.tokens` | [`src/index.css:6`](src/index.css#L6) | Farben, Radien und Schatten der gesamten Oberfläche |
| `stil.touch` | [`src/index.css:4443`](src/index.css#L4443) | Mindestgroesse der Tippziele auf Touch-Geraeten |
...
| `ui.gesamtlagebild` | [`src/pages/GesamtlagebildSeite.tsx:21`](src/pages/GesamtlagebildSeite.tsx#L21) | Regie-Startbildschirm: eine Seitenleiste als Ansichts-Menü |
