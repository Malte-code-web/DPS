...
export const MASSNAHMEN: Record<MassnahmeId, Massnahme> = {
  ...
  wendltubus: {
    ...
    qualifikation: 'basis',
    dauerSek: 30,
    hinweis: 'Nasopharyngealtubus über das Nasenloch; auch bei erhaltenem Würgereflex möglich.',
    indikation: 'Drohende Verlegung durch die zurückfallende Zunge bei noch vorhandenen Schutzreflexen.',
    sofortEffekt: { spo2: 5 },
    sofortmassnahme: true,
  },
  larynxmaske: {
