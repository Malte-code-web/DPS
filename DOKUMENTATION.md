...
_237 Anker, erzeugt von `npm run anker` – nicht von Hand ändern._
...
| `modell.abschnittfuehrenbefehl` | [`src/domain/types.ts:964`](src/domain/types.ts#L964) | Auftrag des Zugführers an einen Gruppenführer, einen Abschnitt zu führen |
...
| `modell.ereignis` | [`src/domain/types.ts:982`](src/domain/types.ts#L982) | Von der Übungsleitung live ausgelöste Lageänderung |
...
| `state.reducer` | [`src/state/reducer.ts:588`](src/state/reducer.ts#L588) | Wie Aktionen den Zustand verändern, inklusive Zeitkosten |
...
| `state.schnappschuss` | [`src/state/reducer.ts:384`](src/state/reducer.ts#L384) | Der geteilte, host-autoritative Ausschnitt des Zustands |
...
| `state.zeitkostenabgleich` | [`src/state/zeitkosten.ts:131`](src/state/zeitkosten.ts#L131) | Erkennt den eigenen Knopf im laufenden Timer |
...
| `test.zeitkostenabgleich` | [`src/state/zeitkosten.test.ts:272`](src/state/zeitkosten.test.ts#L272) | Ein Knopf erkennt, ob genau er gerade läuft |
